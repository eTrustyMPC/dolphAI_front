        ...
        <div className="sticky top-0 z-10 bg-gray-900 border-b border-gray-800">
          <div className="p-3">
            <div
              ...
              className="group relative text-white/90 hover:text-white transition-all p-3 hover:bg-purple-500/10 rounded-xl flex items-center justify-between w-full border border-purple-500/20 hover:border-purple-500/30 hover:shadow-[0_0_15px_rgba(168,85,247,0.15)] active:scale-[0.98] cursor-pointer"
            >
